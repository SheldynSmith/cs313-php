            ...
            <div id="defense" class="stat-section">
                ...
                <div class="defense-grid-container">
                    ...
                    <div id="armor-bonus" class="defense-grid">
                        ...
                        <input type="text" name="armor-bonus" maxlength="4" size="10" value="<?php echo $stats->{"armor-bonus"}?>">
                    </div>
                    <div id="shield-bonus" class="defense-grid">
                        <label>Shield Bonus</label><br>
                        <input type="text" name="shield-bonus" maxlength="4" size="10" value="<?php echo $stats->{"shield-bonus"}?>">
                    </div>
                    <div id="ac-dex-mod" class="defense-grid">
                        <label>Dex Modifier</label><br>
                        <input type="text" name="ac-dex-mod" maxlength="4" size="10" value="<?php echo $stats->{"ac-dex-mod"}?>">
                    </div>
                    <div id="size-mod" class="defense-grid">
                        <label>Size Modifier</label><br>
                        <input type="text" name="size-mod" maxlength="4" size="10" value="<?php echo $stats->{"size-mod"}?>">
                    </div>
                    <div id="natural-armor" class="defense-grid">
                        <label>Natural Armor</label><br>
                        <input type="text" name="natural-armor" maxlength="4" size="10" value="<?php echo $stats->{"natural-armor"}?>">
                    </div>
                    <div id="deflection" class="defense-grid">
                        <label>Deflection</label><br>
                        <input type="text" name="deflection" maxlength="4" size="10" value="<?php echo $stats->{"deflection"}?>">
                    </div>
                    ...
                    <div id="other-ac-mod" class="defense-grid5-16">
                        ...
                        <input type="text" name="other-ac-mod" maxlength="50" size="50" value="<?php echo $stats->{"other-ac-mod"}?>">
                    </div>
                </div>
            </div>
        </form>
